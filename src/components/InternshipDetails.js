  ...
  return (
    <div className="jobContainer">
      ...
      <ul className="jobTopList">
        ...
        <li>
          <ul>
            ...
            <li>
              <b>{moment(jobDetails.lastDate).format("ll")}</b>
            </li>
          </ul>
        </li>
      </ul>
      <h4 style={{ marginTop: 30 }}>
        About Company
        <a href={`${jobDetails.comapanyWebsite}`}>
      ...
      <ul>
        {jobDescription.map((jobDescription) => (
          <li>{jobDescription.content}</li>
        ))}
      </ul>
      <h5>Desired Skills</h5>
      <ul>
        {desiredSkill.map((desiredSkill) => (
          <li>{desiredSkill.content}</li>
        ))}
      </ul>
      <h5>Applying Critaria</h5>
      <ul>
        {criteria.map((criteria) => (
          <li>{criteria.content}</li>
        ))}
      </ul>
      <h5>Perks</h5>
      <ul className="perks">
