  ...
  return (
    <main>
      <Switch>
        ...
        <Route
          path="/viewAllInternships"
          component={ViewAllInternshipsScreen}
        />
        <Route
          path="/viewJobApplicants:jobId"
          component={ViewJobApplicantsScreen}
        />
        ...
        <Route
          ...
          component={ViewAdminJobApplicantScreen}
        />
        ...
        <Route
          path="/viewAllJobApplicants:jobId"
          component={ViewAllJobApplicantsScreen}
        />
      </Switch>
    </main>
  );
